...
The design of the calculation pipeline in the [PFUPipeline][link-pfupipeline] package 
...
in the [PFUAggPipeline][link-pfuaggpipeline] package [@Heun-PFUAggPipeline:2023]
aggregates ECCs
(a) by region 
...
[PFUAggPipeline][link-pfuaggpipeline] packages)
...
The new open source `R` packages described in this paper
enable, for the first time, 
creation of databases of primary, final, and useful
